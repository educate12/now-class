...
class BookInHouseCardWidget extends StatefulWidget {
  BookInHouseCardWidget({
    Key key,
    this.users,
  }) : super(key: key);
  ...
  @override
  _BookInHouseCardWidgetState createState() => _BookInHouseCardWidgetState();
}

class _BookInHouseCardWidgetState extends State<BookInHouseCardWidget> {
  String codeValue;
  String courseValue;
