...
class BookOnlineWidget extends StatefulWidget {
  BookOnlineWidget({Key key}) : super(key: key);

  @override
  _BookOnlineWidgetState createState() => _BookOnlineWidgetState();
}

class _BookOnlineWidgetState extends State<BookOnlineWidget> {
  String codeValue;
  String courseValue;
